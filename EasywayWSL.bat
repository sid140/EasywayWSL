...
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo apt install xrdp
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo apt install -y xfce4
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo apt install -y xfce4-goodies
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl--sudo cp /etc/xrdp/xrdp.ini /etc/xrdp/xrdp.ini.bak
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo sed -i 's/3389/3390/g' /etc/xrdp/xrdp.ini
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo sed -i 's/max_bpp=32/#max_bpp=32\nmax_bpp=128/g' /etc/xrdp/xrdp.ini
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo sed -i 's/xserverbpp=24/#xserverbpp=24\nxserverbpp=128/g' /etc/xrdp/xrdp.ini
pause>nul
Powershell -noprofile -executionpolicy bypass -command wsl-- sudo /etc/init.d/xrdp start
pause>nul
